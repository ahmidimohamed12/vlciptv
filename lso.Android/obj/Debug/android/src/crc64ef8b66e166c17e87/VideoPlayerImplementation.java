...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.MediaManager.VideoPlayerImplementation, Plugin.MediaManager", VideoPlayerImplementation.class, __md_methods);
	}
	...
	public VideoPlayerImplementation ()
	{
		...
		if (getClass () == VideoPlayerImplementation.class)
			mono.android.TypeManager.Activate ("Plugin.MediaManager.VideoPlayerImplementation, Plugin.MediaManager", "", this, new java.lang.Object[] {  });
	}
